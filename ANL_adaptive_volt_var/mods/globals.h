...
/*####*/
GLOBAL int global_client_portnum INIT(10500);
GLOBAL int global_nr_convergence_flag INIT(1);
...
GLOBAL char global_infourl[1024] INIT("http://gridlab-d.sourceforge.net/wiki/index.php?title=Special%3ASearch&go=Go&search="); /**< URL for info calls */
...
GLOBAL double global_timestep INIT(0.0); /**< last time step used */
#ifdef __cplusplus
}
#endif
