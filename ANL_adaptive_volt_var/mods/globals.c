...
static struct s_varmap {
	...
	{"client_portnum",PT_int32,&global_client_portnum, PA_PUBLIC, "synchronization client port number"},
	{"nr_convergence_flag",PT_int32,&global_nr_convergence_flag, PA_PUBLIC, "Newton-Raphson convergence flag"},
	...
	{"last_timestep", PT_double, &global_timestep, PA_REFERENCE, "timestep of last clock update"},
