/** $Id: cmdarg.c 5245 2015-08-15 04:50:40Z ftuffner $
...
/*####*/
static int client_portnum(int argc, char *argv[])
{
	if (argc>1)
	{
		global_client_portnum = (argc--,atoi(*++argv));
		return 1;
	}
	else
	{
		output_fatal("missing synchronization client port number");
		return CMDERR;
	}
}
...
static CMDARG main[] = {
	...
	/*####*/
	{"client_portnum", NULL, client_portnum, NULL, "Sets the synchronization client port number (default is 10500)" },
};
