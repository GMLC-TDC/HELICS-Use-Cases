...
% system variables
global  basmva basrad syn_ref mach_ref sys_freq sys_freq_p n_bus
...
global  ndcr_ud ndci_ud dcrud_idx dciud_idx dcrd_sig dcid_sig freq_pst

%FNCS LOAD variables
global helics_ncload_pre helics_ncload_curr helics_ncload_qre 
global helics_send_freq  helics_recv_freq  freq_received freq_to_record  freq_from_record
...
% Add variable to track frequency changes - modified 
global bus_freq bus_freqf bf_hpf dbf_hpf o2p %theta_un_k
% Add variable -Damping control HVDC
global hvdc_dc_con fdout_hvdc_dc thdiff fr_loc_out fr_rem_out

global iac_test Vdc_test varpru_HVDC kctr