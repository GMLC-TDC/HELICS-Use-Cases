# Contributing to HELICS-Use-Cases
...
## Licensing
HELICS and HELICS-Use-Cases are distributed under the terms of the BSD-3 clause license. All new
...
This section guides you through submitting a bug report for HELICS or other repositories. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior, and find related reports.
...
If you have a new use case or modifications/updates to existing one you would like to submit please submit a pull request against the master branch.
